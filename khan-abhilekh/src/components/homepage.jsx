  ...
  return (
    <div className="flex h-screen bg-gray-100">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <Link to="/alertlogs" className=" cursor-pointer flex items-center gap-2 text-white rounded-lg bg-red-500 px-4 py-2 hover:bg-red-600">
            <Siren size={30} />
          </Link>
          ...
          <Link to="/alert" className=" cursor-pointer flex items-center gap-2 bg-red-500 text-white px-4 py-2 rounded-lg hover:bg-red-600">
